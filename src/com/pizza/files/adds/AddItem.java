...
public class AddItem {
    ...
    private Label info = new Label("Создание нового товара");
    ...
    public AddItem(String caption){
        ...
        ///Label
        ///
        this.info.setPrefSize(400.0, 54.0);
        ...
        ///Text View
        ///
        this.input.setPromptText("Введите название товара");
        this.input.setPrefSize(400.0, 90);
...
//        this.pane.setPrefSize(400.0, 300.0);
    ...
    public void create(ActionEvent actionEvent){
        if(input.getText().trim().equals("")) {
            input.setPromptText("Поле не может быль пустым");
            input.setText("");
        }
        else{
            setSource(input.getText().trim());
            this.stage.hide();
        }
    }
